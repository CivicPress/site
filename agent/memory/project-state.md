...
- **Infrastructure:** GitHub Pages preset configured; CNAME targets `civicpress.io` with `civic-press.org` redirect plan. SEO automation paused pending module compatibility fix.
