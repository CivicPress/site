  ...
  <div >
    ...
    <section class="py-24">
      <UContainer class="max-w-4xl mx-auto text-center">
        ...
        <div class="rounded-xl overflow-hidden shadow-lg border border-gray-200 dark:border-gray-800 bg-black/80">
          <!-- Placeholder for future YouTube embed -->
          <div class="aspect-video flex items-center justify-center text-gray-200">
    ...
    <section class="py-24">
      <UContainer class="max-w-4xl mx-auto text-center">
        ...
        <div class="rounded-xl overflow-hidden shadow-md border border-gray-200 dark:border-gray-800 bg-black/80">
          <!-- Placeholder for future YouTube embed -->
          <div class="aspect-video flex items-center justify-center text-gray-200">
            <span class="text-sm opacity-80">
              “Why CivicPress” video coming soon
            </span>
          </div>
        </div>
      </UContainer>
